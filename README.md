...
- Select a role and number of questions.
- Click Start Interview.
- Type answers in the chat and click Send (or press Enter).
- Receive feedback, corrections, and next questions.
- View session summary after all questions.
